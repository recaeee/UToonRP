#ifndef UTR_Cloth_INCLUDE
#define UTR_Cloth_INCLUDE

//布料Diffuse部分
float3 GetClothDiffuse(UTRSurface surface, Light light, float4 lightInfoMapValue)
{
    float3 diffuse = 0.0;
    ...
    float3 ramp = SAMPLE_TEXTURE2D(_ClothRampMap, sampler_ClothRampMap, float2(0.5, saturate(halfLambert - _ShadowThreshold))).rgb;
    diffuse = ramp;
