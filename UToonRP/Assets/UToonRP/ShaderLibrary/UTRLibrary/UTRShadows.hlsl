//用来在Lit中采样阴影贴图
#ifndef UTR_SHADOWS_INCLUDED
#define UTR_SHADOWS_INCLUDED
...
//计算给定片元将要使用的级联信息
ShadowData GetShadowData(UTRSurface surfaceWS)
{
    ShadowData data;
    //初始化阴影遮罩信息
...
//计算实时阴影
float GetCascadedShadow(DirectionalShadowData directional, ShadowData global, UTRSurface surfaceWS)
{
    //计算法线偏移
...
float GetDirectionalShadowAttenuation(DirectionalShadowData directional, ShadowData global, UTRSurface surfaceWS)
{
    //考虑不接受阴影
