#ifndef UTR_SHADOW_CASTER_PASS_INCLUDED
#define UTR_SHADOW_CASTER_PASS_INCLUDED
...
Varyings UTRShadowCasterPassVertex(Attributes input)
{
    Varyings output;
...
void UTRShadowCasterPassFragment(Varyings input)
{
    //从input中提取实例的ID并将其存储在其他实例化宏所依赖的全局静态变量中
    UNITY_SETUP_INSTANCE_ID(input);
    //LOD过渡
